...
import advogadoTrabalhista from '../../assets/lp-advogadoTrabalhista.png'
import jpTecidos from '../../assets/jptecidos.png'
const Projetos = () => {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"> {/* Adicionado lg:grid-cols-3 para 3 colunas em telas maiores */}
          ...
          <div className="bg-[#111827] rounded-xl shadow-lg overflow-hidden border border-[#1E293B] flex flex-col">
            ...
            {/* QUARTO PROJETO: Card Vertical (duplicado e adaptado) */}

            <div className="bg-[#111827] rounded-xl shadow-lg overflow-hidden border border-[#1E293B] flex flex-col">
            {/* Imagem no topo do card */}
            <div className="w-full h-48 sm:h-56 md:h-64 flex items-center justify-center p-4">
              <img
                src={advogadoTrabalhista}
            ...
            {/* Texto abaixo da imagem */}
            <div className="flex-1 p-6 flex flex-col">
              <h3 className="text-2xl font-bold text-white mb-2">Landing Page - Advogado Trabalhista</h3>

              <p className="text-blue-400 font-medium mb-2">Soluções em advocacia</p>

              <p className="text-gray-400 mb-4 text-sm">
                A Landing Page do Advogado Trabalhista foi desenvolvida para apresentar os serviços advocatícios de forma clara e atraente. O design responsivo garante uma ótima experiência em dispositivos móveis e desktops.
              </p>

              {/* Tags */}
              <div className="flex gap-2 flex-wrap mb-6 mt-auto">
                <span className="bg-gray-700 text-xs px-2 py-1 rounded-full text-white">React</span>
                <span className="bg-gray-700 text-xs px-2 py-1 rounded-full text-white">Tailwind</span>
              </div>

             <div className="flex gap-4">
                <a
                  href="https://advogado-paulomendes.netlify.app/"
                  className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-semibold text-sm"
                >
                  View Project
                </a>
            ...
            {/* Texto abaixo da imagem */}
            <div className="flex-1 p-6 flex flex-col">
              <h3 className="text-2xl font-bold text-white mb-2">Landing Page - JP Tecidos</h3>

              <p className="text-blue-400 font-medium mb-2">Soluções em tecidos</p>

              <p className="text-gray-400 mb-4 text-sm">
                A Landing Page da JP Tecidos foi desenvolvida para apresentar os produtos têxteis de forma clara e atraente. O design responsivo garante uma ótima experiência em dispositivos móveis e desktops.
              </p>
             ...
             <div className="flex gap-4">
                <a
                  href="https://lp-lojajptecidos.vercel.app/"
                  className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-semibold text-sm"
                >
                  View Project
                </a>
